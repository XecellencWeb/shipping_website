...
const GettingStarted = () => {
  ...
  return (
    shrinker?
    <div className='sticky bottom-6 w-32 h-32 flex items-center justify-center rounded-full border-2 border-slate-300 border-opacity-50'>
    ...
    :(
        <div className='sticky bottom-6 w-32 h-32 flex items-center justify-center rounded-full'>
