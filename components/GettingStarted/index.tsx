...
const GettingStarted = () => {
  ...
  return (
    shrinker?(
    <div className='sticky scale_in bottom-0 ml-4 w-32 h-32 flex items-center justify-center rounded-full border-2 border-slate-300 border-opacity-50'>
        <div className="absolute -top-16 left-1/2 flex gap-1 items-center">
        <i className="bi bi-play-circle text-5xl"></i>
            <Link href='/calculateshipping' className='px-4 py-2 bg-slate-50 bg-opacity-50  text-base block w-32  m-4 rounded-lg font-black'>Get Started</Link>
        </div>

        <div className="absolute top-1/2 -translate-y-1/2 left-32 flex gap-1 items-center">
        <i className="bi bi-sign-railroad text-5xl"></i>
            <button onClick={()=>scrollToId('tracking')} className='px-4 py-2 bg-slate-50 bg-opacity-50  text-base block w-40  m-4 rounded-lg font-black'>track goods</button>
        </div>
    ...
    :(
        <div className='sticky scale_in bottom-0 ml-4 w-32 h-32 flex items-center justify-center rounded-full'>
